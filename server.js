...
setVariables().then(function(){
    ...
    const appRouter = require(global.SERVER_ROOT + ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/app/app.router');
    const app_categoryRouter = require(global.SERVER_ROOT + ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/app_category/app_category.router');
    const app_logRouter = require(global.SERVER_ROOT + ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/app_log/app_log.router');
    const app_objectRouter = require(global.SERVER_ROOT + ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/app_object/app_object.router');
    const app_parameterRouter = require(global.SERVER_ROOT + ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/app_parameter/app_parameter.router');
    const app_roleRouter = require(global.SERVER_ROOT + ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/app_role/app_role.router');
    const countryRouter = require(global.SERVER_ROOT + ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/country/country.router');
    const identity_providerRouter = require(global.SERVER_ROOT + ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/identity_provider/identity_provider.router');
    const languageLocaleRouter = require(global.SERVER_ROOT + ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/language/locale/locale.router');
    const message_translationRouter = require(global.SERVER_ROOT + ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/message_translation/message_translation.router');
    const parameter_typeRouter = require(global.SERVER_ROOT + ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/parameter_type/parameter_type.router');
    const settingRouter = require(global.SERVER_ROOT + ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/setting/setting.router');
    const user_accountRouter = require(global.SERVER_ROOT + ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/user_account/user_account.router');
    const user_account_appRouter = require(global.SERVER_ROOT + ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/user_account_app/user_account_app.router');
    const user_account_likeRouter = require(global.SERVER_ROOT + ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/user_account_like/user_account_like.router');
    const user_account_logonRouter = require(global.SERVER_ROOT + ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/user_account_logon/user_account_logon.router');
    const user_account_followRouter = require(global.SERVER_ROOT + ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/user_account_follow/user_account_follow.router');
    //service geolocation
    ...
    app.use(ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/app', appRouter);
    app.use(ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/app_category', app_categoryRouter);
    app.use(ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/app_log', app_logRouter);
    app.use(ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/app_object', app_objectRouter);
    app.use(ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/app_parameter', app_parameterRouter);
    app.use(ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/app_role', app_roleRouter);
    app.use(ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/country', countryRouter);
    app.use(ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/identity_provider', identity_providerRouter);
    app.use(ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/language/locale', languageLocaleRouter);
    app.use(ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/message_translation', message_translationRouter);
    app.use(ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/parameter_type', parameter_typeRouter);
    app.use(ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/setting', settingRouter);
    app.use(ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/user_account', user_accountRouter);
    app.use(ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/user_account_app', user_account_appRouter);
    app.use(ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/user_account_like', user_account_likeRouter);
    app.use(ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/user_account_logon', user_account_logonRouter);
    app.use(ConfigGet(1, 'SERVICE_DB', 'REST_API_PATH') + '/user_account_follow', user_account_followRouter);
    //service geolocation
    ...
    if (ConfigGet(1, 'SERVER', 'HTTPS_ENABLE')==1){
      ...
      //SSL files for HTTPS
      let options;
      fs.readFile(global.SERVER_ROOT + ConfigGet(1, 'SERVER', 'HTTPS_KEY'), 'utf8', (error, fileBuffer) => {
        let env_key = fileBuffer.toString();
        fs.readFile(global.SERVER_ROOT + ConfigGet(1, 'SERVER', 'HTTPS_CERT'), 'utf8', (error, fileBuffer) => {
