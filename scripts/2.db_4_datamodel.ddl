...
ALTER TABLE <DB_SCHEMA/>.app_category ADD CONSTRAINT app_category_pk PRIMARY KEY ( id );
...
ALTER TABLE <DB_SCHEMA/>.app_device ADD CONSTRAINT app_device_pk PRIMARY KEY ( app_id,
                                                                                app_setting_id );
...
ALTER TABLE <DB_SCHEMA/>.app_log ADD CONSTRAINT app_log_pk PRIMARY KEY ( id );
...
ALTER TABLE <DB_SCHEMA/>.app_object ADD CONSTRAINT app_object_pk PRIMARY KEY ( object_name,
                                                                                app_id );
...
ALTER TABLE <DB_SCHEMA/>.app_translation
    ADD CONSTRAINT app_translation_app_object_item_un UNIQUE ( app_object_item_app_object_object_name,
                                                               app_object_item_object_item_name,
                                                               app_object_item_app_object_app_id,
                                                               language_id );

ALTER TABLE <DB_SCHEMA/>.app_translation
    ADD CONSTRAINT app_translation_app_object_object_un UNIQUE ( app_object_object_name,
                                                                 app_object_app_id,
                                                                 language_id );
...
ALTER TABLE <DB_SCHEMA/>.country ADD CONSTRAINT country_pk PRIMARY KEY ( id );
...
ALTER TABLE <DB_SCHEMA/>.country_group ADD CONSTRAINT country_group_pk PRIMARY KEY ( id );
...
ALTER TABLE <DB_SCHEMA/>.app_translation
    ADD CONSTRAINT app_translation_language_fkv1 FOREIGN KEY ( language_id_translation )
        REFERENCES <DB_SCHEMA/>.language ( id )
    NOT DEFERRABLE;
