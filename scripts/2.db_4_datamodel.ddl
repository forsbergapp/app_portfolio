...
ALTER TABLE app_portfolio.app_setting
    ADD CONSTRAINT app_setting_app_id_app_setting_type_name_value_un UNIQUE ( app_setting_type_app_id,
...
ALTER TABLE app_portfolio.app_setting_type ADD CONSTRAINT app_setting_type_pk PRIMARY KEY ( app_id,
...
CREATE INDEX app_portfolio.app_translation_app_search_idx ON
...
CREATE INDEX app_portfolio.app_translation_app_category_search_idx ON
    app_portfolio.app_translation (
        language_id
    ASC,
        app_category_id
...
CREATE INDEX app_portfolio.app_translation_app_setting_search_idx ON
    app_portfolio.app_translation (
        language_id
    ASC,
        app_setting_id
...
CREATE INDEX app_portfolio.app_translation_app_object_search_idx ON
    app_portfolio.app_translation (
        language_id
    ASC,
        app_object_object_name
...
CREATE INDEX app_portfolio.app_translation_app_object_item_search_idx ON
    app_portfolio.app_translation (
        language_id
    ASC,
...
CREATE INDEX app_portfolio.app_translation_parameter_type_search_idx ON
    app_portfolio.app_translation (
        language_id
    ASC,
        parameter_type_id
...
CREATE INDEX app_portfolio.app_translation_app_message_search_idx ON
    app_portfolio.app_translation (
        language_id
    ASC,
        app_message_app_id
...
CREATE INDEX app_portfolio.app_translation_country_search_idx ON
    app_portfolio.app_translation (
        language_id
    ASC,
        country_id
...
CREATE INDEX app_portfolio.app_translation_language_translation_search_idx ON
    app_portfolio.app_translation (
        language_id
    ASC,
