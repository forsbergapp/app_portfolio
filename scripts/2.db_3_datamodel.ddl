...
ALTER TABLE <DB_SCHEMA/>.app_log OWNER TO app_portfolio;
ALTER TABLE <DB_SCHEMA/>.app_object OWNER TO app_portfolio;
ALTER TABLE <DB_SCHEMA/>.app_object_item OWNER TO app_portfolio;
ALTER TABLE <DB_SCHEMA/>.app_role OWNER TO app_portfolio;
...
ALTER TABLE <DB_SCHEMA/>.country OWNER TO app_portfolio;
ALTER TABLE <DB_SCHEMA/>.country_group OWNER TO app_portfolio;
...
ALTER TABLE <DB_SCHEMA/>.locale OWNER TO app_portfolio;
ALTER TABLE <DB_SCHEMA/>.profile_search OWNER TO app_portfolio;
