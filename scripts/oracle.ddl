...
ALTER TABLE app ADD CONSTRAINT app_pk PRIMARY KEY ( id );
...
CREATE TABLE app_log (
    ...
    app_module_request          VARCHAR2(100),
...
COMMENT ON COLUMN app_log.app_module IS
    'INIT
AUTH
MAIL
GEOLOCATION
...
COMMENT ON COLUMN app_log.app_module_type IS
    'INIT 			
AUTH_TOKEN_GET
send:
...
COMMENT ON COLUMN app_log.app_module_request IS
    'INIT: 
...
COMMENT ON COLUMN app_log.app_module_result IS
    'successful info or any error message ';

COMMENT ON COLUMN app_log.user_language IS
    'navigator.language';

COMMENT ON COLUMN app_log.user_timezone IS
    'Intl.DateTimeFormat().resolvedOptions().timeZone;';

COMMENT ON COLUMN app_log.user_number_system IS
    'Intl.NumberFormat().resolvedOptions().numberingSystem';

COMMENT ON COLUMN app_log.user_platform IS
    'navigator.platform';

ALTER TABLE app_log ADD CONSTRAINT app_log_pk PRIMARY KEY ( id );
...
ALTER TABLE app_message ADD CONSTRAINT app_message_pk PRIMARY KEY ( message_code,
                                                                    app_id );
...
ALTER TABLE app_object ADD CONSTRAINT app_object_pk PRIMARY KEY ( object_name,
                                                                  app_id );
...
ALTER TABLE app_parameter ADD CONSTRAINT app_parameter_pk PRIMARY KEY ( app_id,
                                                                        parameter_name );
...
ALTER TABLE app_timetables_place ADD CONSTRAINT app_timetables_place_pk PRIMARY KEY ( id );
...
ALTER TABLE app_timetables_theme ADD CONSTRAINT app_timetables_theme_pk PRIMARY KEY ( id );
...
ALTER TABLE app_timetables_user_setting ADD CONSTRAINT app_timetables_user_setting_pk PRIMARY KEY ( id );
...
ALTER TABLE app_timetables_user_setting_hist ADD CONSTRAINT app_timetables_user_setting_hist_pk PRIMARY KEY ( id );
...
ALTER TABLE app_timetables_user_setting_like ADD CONSTRAINT app_timetables_user_setting_like_pk PRIMARY KEY ( user_account_id,
                                                                                                              user_setting_id );
...
ALTER TABLE app_timetables_user_setting_like_hist ADD CONSTRAINT app_timetables_user_setting_like_hist_pk PRIMARY KEY ( id );
...
ALTER TABLE app_timetables_user_setting_view_hist ADD CONSTRAINT app_timetables_user_setting_view_hist_pk PRIMARY KEY ( id );
...
ALTER TABLE country_group ADD CONSTRAINT country_group_pk PRIMARY KEY ( id );
...
ALTER TABLE country_translation ADD CONSTRAINT country_translation_pk PRIMARY KEY ( country_id,
                                                                                    language_id );
...
ALTER TABLE group_place ADD CONSTRAINT group_place_pk PRIMARY KEY ( id );

ALTER TABLE group_place ADD CONSTRAINT group_place_group_name_un UNIQUE ( group_name );
...
ALTER TABLE language_translation ADD CONSTRAINT language_translation_pk PRIMARY KEY ( language_translation_id,
                                                                                      language_id );
...
ALTER TABLE message ADD CONSTRAINT message_pk PRIMARY KEY ( code );
...
ALTER TABLE message_level ADD CONSTRAINT message_level_pk PRIMARY KEY ( id );
...
ALTER TABLE message_translation ADD CONSTRAINT message_translation_pk PRIMARY KEY ( language_id,
                                                                                    message_code );
...
ALTER TABLE message_type ADD CONSTRAINT message_type_pk PRIMARY KEY ( id );
...
ALTER TABLE profile_search_hist ADD CONSTRAINT profile_search_hist_pk PRIMARY KEY ( id );
...
ALTER TABLE theme_category ADD CONSTRAINT theme_category_pk PRIMARY KEY ( id );
...
ALTER TABLE theme_type ADD CONSTRAINT theme_type_pk PRIMARY KEY ( id );
...
ALTER TABLE user_account_app ADD CONSTRAINT user_account_app_pk PRIMARY KEY ( app_id,
                                                                              user_account_id );
...
ALTER TABLE user_account_app_hist ADD CONSTRAINT user_account_app_hist_pk PRIMARY KEY ( id );
...
ALTER TABLE user_account_follow ADD CONSTRAINT user_account_follow_pk PRIMARY KEY ( user_account_id,
...
ALTER TABLE user_account_follow_hist ADD CONSTRAINT user_account_follow_hist_pk PRIMARY KEY ( id );
...
ALTER TABLE user_account_hist ADD CONSTRAINT user_account_hist_pk PRIMARY KEY ( id );
...
ALTER TABLE user_account_like ADD CONSTRAINT user_account_like_pk PRIMARY KEY ( user_account_id,
...
ALTER TABLE user_account_like_hist ADD CONSTRAINT user_account_like_hist_pk PRIMARY KEY ( id );
...
ALTER TABLE user_account_logon_hist ADD CONSTRAINT user_account_logon_hist_pk PRIMARY KEY ( id );
...
ALTER TABLE user_account_view_hist ADD CONSTRAINT user_account_view_hist_pk PRIMARY KEY ( id );
...
ALTER TABLE user_account_like
    ADD CONSTRAINT user_account_like_user_account_fkv1 FOREIGN KEY ( user_account_id_like )
        REFERENCES user_account ( id )
            ON DELETE CASCADE
    NOT DEFERRABLE;
...
ALTER TABLE user_account_view
    ADD CONSTRAINT user_account_view_user_account_fkv1 FOREIGN KEY ( user_account_id_view )
        REFERENCES user_account ( id )
            ON DELETE CASCADE
    NOT DEFERRABLE;

CREATE OR REPLACE TRIGGER app_timetables_user_setting_before_delete 
...
CREATE OR REPLACE TRIGGER app_timetables_user_setting_before_insert 
...
CREATE OR REPLACE TRIGGER app_timetables_user_setting_before_update 
...
CREATE OR REPLACE TRIGGER app_timetables_user_setting_like_before_delete 
...
CREATE OR REPLACE TRIGGER app_timetables_user_setting_like_before_insert 
...
CREATE OR REPLACE TRIGGER app_timetables_user_setting_like_before_update 
...
CREATE OR REPLACE TRIGGER app_timetables_user_setting_view_before_delete 
...
CREATE OR REPLACE TRIGGER app_timetables_user_setting_view_before_insert 
...
CREATE OR REPLACE TRIGGER app_timetables_user_setting_view_before_update 
...
CREATE OR REPLACE TRIGGER profile_search_before_delete 
...
CREATE OR REPLACE TRIGGER profile_search_before_insert 
...
CREATE OR REPLACE TRIGGER profile_search_before_update 
...
CREATE OR REPLACE TRIGGER user_account_app_before_delete 
...
CREATE OR REPLACE TRIGGER user_account_app_before_insert 
...
CREATE OR REPLACE TRIGGER user_account_app_before_update 
...
CREATE OR REPLACE TRIGGER user_account_before_delete 
...
CREATE OR REPLACE TRIGGER user_account_before_insert 
...
CREATE OR REPLACE TRIGGER user_account_before_update 
...
CREATE OR REPLACE TRIGGER user_account_follow_before_delete 
...
CREATE OR REPLACE TRIGGER user_account_follow_before_insert 
...
CREATE OR REPLACE TRIGGER user_account_follow_before_update 
...
CREATE OR REPLACE TRIGGER user_account_like_before_delete 
...
CREATE OR REPLACE TRIGGER user_account_like_before_insert 
...
CREATE OR REPLACE TRIGGER user_account_like_before_update 
...
CREATE OR REPLACE TRIGGER user_account_logon_before_delete 
...
CREATE OR REPLACE TRIGGER user_account_logon_before_insert 
...
CREATE OR REPLACE TRIGGER user_account_logon_before_update 
...
CREATE OR REPLACE TRIGGER user_account_view_before_delete 
...
CREATE OR REPLACE TRIGGER user_account_view_before_insert 
...
CREATE OR REPLACE TRIGGER user_account_view_before_update 
