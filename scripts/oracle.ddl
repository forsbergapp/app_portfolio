...
CREATE ROLE role_app0 NOT IDENTIFIED;

GRANT connect,
    CREATE SESSION, resource TO role_app0;
...
ALTER TABLE app_portfolio.app1_group_place ADD CONSTRAINT app1_group_place_pk PRIMARY KEY ( id );
...
ALTER TABLE app_portfolio.app1_place ADD CONSTRAINT app1_place_pk PRIMARY KEY ( id );
...
ALTER TABLE app_portfolio.app1_theme ADD CONSTRAINT app1_theme_pk PRIMARY KEY ( id );
...
ALTER TABLE app_portfolio.app1_theme_category ADD CONSTRAINT app1_theme_category_pk PRIMARY KEY ( id );
...
ALTER TABLE app_portfolio.app1_theme_type ADD CONSTRAINT app1_theme_type_pk PRIMARY KEY ( id );
...
CREATE TABLE app_portfolio.app1_user_setting (
    ...
    regional_current_timezone          VARCHAR2(100),
...
ALTER TABLE app_portfolio.app1_user_setting ADD CONSTRAINT app1_user_setting_pk PRIMARY KEY ( id );
...
ALTER TABLE app_portfolio.app1_user_setting_hist ADD CONSTRAINT app1_user_setting_hist_pk PRIMARY KEY ( id );
...
ALTER TABLE app_portfolio.app1_user_setting_like ADD CONSTRAINT app1_user_setting_like_pk PRIMARY KEY ( user_account_id,
                                                                                                        app1_user_setting_id );

ALTER TABLE app_portfolio.app1_user_setting_like ADD CONSTRAINT app1_user_setting_like_id_un UNIQUE ( id );
...
ALTER TABLE app_portfolio.app1_user_setting_like_hist ADD CONSTRAINT app1_user_setting_like_hist_pk PRIMARY KEY ( id );
...
ALTER TABLE app_portfolio.app1_user_setting_view_hist ADD CONSTRAINT app1_user_setting_view_hist_pk PRIMARY KEY ( id );
...
ALTER TABLE app_portfolio.app1_place
    ADD CONSTRAINT app1_place_app1_group_place_fk FOREIGN KEY ( group_place1_id )
        REFERENCES app_portfolio.app1_group_place ( id )
    NOT DEFERRABLE;

ALTER TABLE app_portfolio.app1_place
    ADD CONSTRAINT app1_place_app1_group_place2_fk FOREIGN KEY ( group_place2_id )
        REFERENCES app_portfolio.app1_group_place ( id )
    NOT DEFERRABLE;

ALTER TABLE app_portfolio.app1_place
    ADD CONSTRAINT app1_place_country_fk FOREIGN KEY ( country1_id )
...
ALTER TABLE app_portfolio.app1_theme
    ADD CONSTRAINT app1_theme_app1_theme_category_fk FOREIGN KEY ( app1_theme_category_id )
        REFERENCES app_portfolio.app1_theme_category ( id )
    NOT DEFERRABLE;

ALTER TABLE app_portfolio.app1_theme
    ADD CONSTRAINT app1_theme_app1_theme_type_fk FOREIGN KEY ( app1_theme_type_id )
        REFERENCES app_portfolio.app1_theme_type ( id )
    NOT DEFERRABLE;

ALTER TABLE app_portfolio.app1_user_setting
    ADD CONSTRAINT app1_user_setting_app1_place_fk FOREIGN KEY ( gps_popular_place_id )
        REFERENCES app_portfolio.app1_place ( id )
    NOT DEFERRABLE;

ALTER TABLE app_portfolio.app1_user_setting
    ADD CONSTRAINT app1_user_setting_app1_theme_day_fk FOREIGN KEY ( design_theme_day_id )
        REFERENCES app_portfolio.app1_theme ( id )
    NOT DEFERRABLE;
...
ALTER TABLE app_portfolio.app1_user_setting_like
    ADD CONSTRAINT app1_user_setting_like_app1_user_setting_fk FOREIGN KEY ( app1_user_setting_id )
        REFERENCES app_portfolio.app1_user_setting ( id )
            ON DELETE CASCADE
    NOT DEFERRABLE;
...
ALTER TABLE app_portfolio.app1_user_setting
    ADD CONSTRAINT app1_user_setting_user_account_app_fk FOREIGN KEY ( app_id,
                                                                       user_account_id )
        REFERENCES app_portfolio.user_account_app ( app_id,
                                                    user_account_id )
            ON DELETE CASCADE
    NOT DEFERRABLE;
...
ALTER TABLE app_portfolio.regional_setting_translation
    ADD CONSTRAINT regional_setting_translation_regional_setting_item_fk FOREIGN KEY ( regional_setting_id )
...
CREATE OR REPLACE TRIGGER app_portfolio.app1_user_setting_before_delete 
...
CREATE OR REPLACE TRIGGER app_portfolio.app1_user_setting_before_insert 
...
CREATE OR REPLACE TRIGGER app_portfolio.app1_user_setting_before_update 
...
CREATE OR REPLACE TRIGGER app_portfolio.app1_user_setting_like_before_delete 
...
CREATE OR REPLACE TRIGGER app_portfolio.app1_user_setting_like_before_insert 
...
CREATE OR REPLACE TRIGGER app_portfolio.app1_user_setting_like_before_update 
...
CREATE OR REPLACE TRIGGER app_portfolio.app1_user_setting_view_before_delete 
...
CREATE OR REPLACE TRIGGER app_portfolio.app1_user_setting_view_before_insert 
...
CREATE OR REPLACE TRIGGER app_portfolio.app1_user_setting_view_before_update 
