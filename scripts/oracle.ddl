...
CREATE TABLE app_portfolio.app_object_subitem_translation (
    ...
    app_object_item_subitem_app_object_item_object_name      VARCHAR2(100) NOT NULL,
...
ALTER TABLE app_portfolio.app2_setting ADD CONSTRAINT app2_setting_pk PRIMARY KEY ( id );
...
ALTER TABLE app_portfolio.app2_setting_translation ADD CONSTRAINT app2_setting_translation_pk PRIMARY KEY ( app2_setting_id,
                                                                                                            language_id );
...
ALTER TABLE app_portfolio.app2_setting_type ADD CONSTRAINT app2_setting_type_pk PRIMARY KEY ( id );
