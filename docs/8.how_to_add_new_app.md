...
# Required
                                        ...
                                        <head>
                                            ...
                                            <script type='text/javascript' type='module' >
                                                import('/app[APP_ID]}/js/app.js').then(function(app){
                                                    window.app = app;
                                                    document.addEventListener("DOMContentLoaded", app.init(<ITEM_COMMON_PARAMETERS/>));
                                                });
                                            </script>
                                        </head>	
                                        <body>
                                            ...
                                            <head>
                                                <script type='text/javascript' type='module' >
                                                    import('/app[APP_ID]/js/report.js').then(function(report){
                                                            ...
                                                            document.addEventListener("DOMContentLoaded", report.init(<ITEM_COMMON_PARAMETERS/>));
                                                    });
                                                </script>        
                                            </head>	
                                            <body>
    ...
    example call reports from client /apps/app[APP_ID]/js/app.js
        ...
        window.global_app_report_timetable = '[REPORT_NAME]';
