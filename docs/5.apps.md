...
# How to add a new app
    ...
    1.Add app in /server/install/default_config_apps.json
        ...
        this will be generated installing first time as /data/config_apps.json with secrets created using SHA256
    ...
    /server/install/scripts/4.db_all_inserts_data.sql
    ...
    /apps/app[APP_ID]/src/report/index.js review example in /apps/app2/src/report/timetable.js
                                        minimum:
    ...
    example call reports from app using /apps/app[APP_ID]/public/js/app.js
        const get_report_url = (id, papersize, format) => {
            ...
            let service_parameter = `&format=${format}&ps=${papersize}&hf=0`; //html, papersize, header/footer
