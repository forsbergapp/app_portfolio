...
# Install database
    ...
    MariaDB
        ...
        docker installation:
            ...
            sudo docker run --name mariadb -p 3306:3306 -e MARIADB_ROOT_PASSWORD='ROOT_PASSWORD' -d mariadb:11.1.2 --default-authentication-plugin=mysql_native_password --skip-name-resolve --bind-address=0.0.0.0
            ...
            docker run --name mariadb -p 3306:3306 -e MARIADB_ROOT_PASSWORD='ROOT_PASSWORD' -d mariadb:11.1.2 --default-authentication-plugin=mysql_native_password --skip-name-resolve
    ...
    MySQL
        ...
        docker installation:
            ...
            --and network performance tweak
            --use single quote for password on Ubuntu
            sudo docker run --name mysql -p 3307:3306 -e MYSQL_ROOT_PASSWORD='ROOT_PASSWORD' -d mysql:8.0.34 --default-authentication-plugin=mysql_native_password --skip-name-resolve --bind-address=0.0.0.0 
