...
# Run database scripts
    ...
    MariaDB    
        ...
        /scripts/2.db_1_2_datamodel_mariadb_mysql.ddl
    ...
    Oracle
        /scripts/2.db_4_datamodel_oracle.ddl
        /scripts/3.db_4_grant_role_fix_oracle.ddl
        /scripts/4.db_all_insert_data.sql			(creates admin as superadmin user)
        /scripts/4.db_4_insert_data_with_secret.sql
        /scripts/5.db_all_lang.sql					(concatenated script)
    ...
    MariaDB    
        /scripts/6.db_1__2_demo_mariadb_mysql.sql
    MySQL
        /scripts/6.db_1_2_demo_mariadb_mysql.sql	
    PostgreSQL
        /scripts/6.db_3_demo_postgresql.sql
    Oracle
        /scripts/6.db_4_demo_oracle.sql	

    --uninstall scripts when neeeded:
    MariaDB    
        /scripts/7.db_1_2_uninstall.sql
    MySQL
        /scripts/7.db_1_2_uninstall.sql
    PostgreSQL
        /scripts/7.db_3_uninstall.sql
    Oracle
        /scripts/7.db_4_uninstall.sql
