...
/**@type{import('../../dbapi/sql/app_log.service.js')} */
const service = await import(`file://${process.cwd()}/server/dbapi/sql/app_log.service.js`);
    ...
    return new Promise((resolve, reject)=>{
        ...
        .then((/**@type{import('../../../types.js').db_result_app_log_getLogsAdmin[]}*/result_logs) =>{
            if (result_logs.length>0)
                ...
                .then((/**@type{import('../common/common.service.js')} */{record_not_found}) => {
