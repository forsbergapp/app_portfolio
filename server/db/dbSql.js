...
const USER_ACCOUNT_INSERT = 
    ...
    VALUES( :bio,
            ...
            :provider_image_url,
            :provider_email) `;
const USER_ACCOUNT_UDPATE_ACTIVATE =
    `UPDATE <DB_SCHEMA/>.user_account
        SET active = 1,
...
const USER_ACCOUNT_UPDATE_LOCAL =
    `UPDATE <DB_SCHEMA/>.user_account
        SET bio = :bio,
            ...
            date_modified = CURRENT_TIMESTAMP
      WHERE id = :id `;
const USER_ACCOUNT_UDPATE_COMMON =
    `UPDATE <DB_SCHEMA/>.user_account
...
export {/**APP_DATA_ENTITIY_RESOURCE */
        ...
        USER_ACCOUNT_UPDATE,
        USER_ACCOUNT_INSERT,USER_ACCOUNT_UDPATE_ACTIVATE,USER_ACCOUNT_UPDATE_VERIFICATION_CODE,
        USER_ACCOUNT_SELECT_ID,USER_ACCOUNT_SELECT_PROFILE,USER_ACCOUNT_SELECT_PROFILE_DETAIL,USER_ACCOUNT_SELECT_PROFILE_STAT,
        USER_ACCOUNT_SELECT_PASWORD,USER_ACCOUNT_UPDATE_PASSWORD,USER_ACCOUNT_UPDATE_LOCAL,USER_ACCOUNT_UDPATE_COMMON,USER_ACCOUNT_DELETE,
