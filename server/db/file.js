...
const FILE_DB = [   {NAME:'CONFIG_SERVER',                  TYPE:'JSON',            LOCK:0, TRANSACTION_ID:0,   TRANSACTION_CONTENT: null, PATH:`${SLASH}data${SLASH}`,                     FILENAME:'config_server.json', CACHE_CONTENT:null},
                    {NAME:'CONFIG_REST_API',                TYPE:'JSON',            LOCK:0, TRANSACTION_ID:0,   TRANSACTION_CONTENT: null, PATH:`${SLASH}data${SLASH}`,                     FILENAME:'config_rest_api.json', CACHE_CONTENT:null},
                    ...
                    {NAME:'APP_TRANSLATION',                TYPE:'JSON_TABLE',      LOCK:0, TRANSACTION_ID:0,   TRANSACTION_CONTENT: null, PATH:`${SLASH}data${SLASH}db${SLASH}`,           FILENAME:'app_translation.json', CACHE_CONTENT:null},
                    ...
                    {NAME:'IAM_APP_ID_TOKEN',               TYPE:'JSON_TABLE',      LOCK:0, TRANSACTION_ID:0,   TRANSACTION_CONTENT: null, PATH:`${SLASH}data${SLASH}iam${SLASH}`,          FILENAME:'iam_app_id_token.json', CACHE_CONTENT:null},
                    {NAME:'IAM_CONTROL_IP',                 TYPE:'JSON_TABLE',      LOCK:0, TRANSACTION_ID:0,   TRANSACTION_CONTENT: null, PATH:`${SLASH}data${SLASH}iam${SLASH}`,          FILENAME:'iam_control_ip.json', CACHE_CONTENT:null},
                    {NAME:'IAM_CONTROL_USER_AGENT',         TYPE:'JSON_TABLE',      LOCK:0, TRANSACTION_ID:0,   TRANSACTION_CONTENT: null, PATH:`${SLASH}data${SLASH}iam${SLASH}`,          FILENAME:'iam_control_user_agent.json', CACHE_CONTENT:null},
                    {NAME:'IAM_CONTROL_OBSERVE',            TYPE:'JSON_TABLE',      LOCK:0, TRANSACTION_ID:0,   TRANSACTION_CONTENT: null, PATH:`${SLASH}data${SLASH}iam${SLASH}`,          FILENAME:'iam_control_observe.json', CACHE_CONTENT:null},
                    ...
                    {NAME:'IAM_USER_APP_ACCESS',            TYPE:'JSON_TABLE',      LOCK:0, TRANSACTION_ID:0,   TRANSACTION_CONTENT: null, PATH:`${SLASH}data${SLASH}iam${SLASH}`,          FILENAME:'iam_user_app_access.json', CACHE_CONTENT:null},
                    ...
                    {NAME:'MESSAGE_QUEUE_PUBLISH',          TYPE:'JSON_LOG',        LOCK:0, TRANSACTION_ID:0,   TRANSACTION_CONTENT: null, PATH:`${SLASH}data${SLASH}microservice${SLASH}`, FILENAME:'message_queue_publish.log'},
                    {NAME:'MESSAGE_QUEUE_CONSUME',          TYPE:'JSON_LOG',        LOCK:0, TRANSACTION_ID:0,   TRANSACTION_CONTENT: null, PATH:`${SLASH}data${SLASH}microservice${SLASH}`, FILENAME:'message_queue_consume.log'},
                    {NAME:'MESSAGE_QUEUE_ERROR',            TYPE:'JSON_LOG',        LOCK:0, TRANSACTION_ID:0,   TRANSACTION_CONTENT: null, PATH:`${SLASH}data${SLASH}microservice${SLASH}`, FILENAME:'message_queue_error.log'}];
Object.seal(FILE_DB);
