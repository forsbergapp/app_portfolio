...
const FILE_DB = [   {NAME:'CONFIG_SERVER',                  TYPE:'JSON',            PK:null, UK:null,                           LOCK:0, TRANSACTION_ID:0,   TRANSACTION_CONTENT: null, PATH:`${SLASH}data${SLASH}`,                     FILENAME:'config_server.json', CACHE_CONTENT:null},
                    ...
                    {NAME:'APP_SETTING',                    TYPE:'JSON_TABLE',      PK:'id', UK:['app_id, name', 'value'],      LOCK:0, TRANSACTION_ID:0,   TRANSACTION_CONTENT: null, PATH:`${SLASH}data${SLASH}db${SLASH}`,           FILENAME:'app_setting.json', CACHE_CONTENT:null},
                    ...
                    {NAME:'IAM_USER_EVENT',                 TYPE:'JSON_TABLE',      PK:'id', UK:null,                           LOCK:0, TRANSACTION_ID:0,   TRANSACTION_CONTENT: null, PATH:`${SLASH}data${SLASH}iam${SLASH}`,          FILENAME:'iam_user_event.json', CACHE_CONTENT:null},
