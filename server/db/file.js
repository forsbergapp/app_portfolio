...
const FILE_DB = [   {NAME:'CONFIG_SERVER',                  TYPE:'JSON',            LOCK:0, TRANSACTION_ID:0,   TRANSACTION_CONTENT: null, PATH:`${SLASH}data${SLASH}`,                     FILENAME:'config_server.json', CACHE_CONTENT:null},
                    ...
                    {NAME:'IAM_USER_LOGIN',                 TYPE:'JSON_TABLE',      LOCK:0, TRANSACTION_ID:0,   TRANSACTION_CONTENT: null, PATH:`${SLASH}data${SLASH}iam${SLASH}`,          FILENAME:'iam_user_login.json', CACHE_CONTENT:null},
