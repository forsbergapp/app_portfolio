    ...
    it('should return converted sql and parameters in correct format for the database used for SELECT, INSERT, DELETE and UPDATE sql', async () =>{
        ...
        const pool_1_2 = async (app_id, db_use) =>{
            ...
            const parameters = {use:            db_use, 
                                pool_id:        app_id, 
                                port:           serverUtilNumberValue(Config.get('ConfigServer','SERVICE_DB', 'DB1_PORT')),
                                host:           Config.get('ConfigServer','SERVICE_DB', 'DB1_HOST'),
                                dba:            true,
                                user:           Config.get('ConfigServer','SERVICE_DB', 'DB1_DBA_USER'),
                                password:       Config.get('ConfigServer','SERVICE_DB', 'DB1_DBA_PASS'),
        ...
        console.log('Unit test dbSQLParamConvert parameter db name:', Config.get('ConfigServer','SERVICE_DB', `DB${db_use}_NAME`) ?? '');
