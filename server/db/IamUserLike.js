 ...
 * @param {{app_id:number,
 *          data:server['ORM']['IamUserLike']}} parameters
...
const post = async parameters =>{
    ...
    if (parameters.data.iam_user_id==null || parameters.data.iam_user_id_like==null){
        ...
        return server.ORM.Execute({app_id:parameters.app_id, dml:'POST', object:'IamUserLike', post:{data:data_new}}).then((/**@type{server['ORMMetaData']['common_result_insert']}*/result)=>{
