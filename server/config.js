...
const configDefault = async () => {
    ...
    /**@type{[  [server_db_file_db_name, server_config_server],
                [server_db_file_db_name, server_config_iam_blockip],
                [server_db_file_db_name, server_config_iam_policy],
                [server_db_file_db_name, server_config_iam_useragent],
    ...
    */
    ...
    config_obj[5][1].SERVICES.map((/**@type{microservice_config_service_record}*/row)=>{
