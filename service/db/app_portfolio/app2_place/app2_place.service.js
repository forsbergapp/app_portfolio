		...
		if (process.env.SERVICE_DB_USE == 1) {
			sql = ` SELECT	p.id,
						...
						FROM
							...
							${process.env.SERVICE_DB_DB1_NAME}.app2_group_place  gp1, 
							${process.env.SERVICE_DB_DB1_NAME}.app2_group_place  gp2,
							${process.env.SERVICE_DB_DB1_NAME}.app2_place        p
			...
			sql = `SELECT	p.id "id",
						...
						FROM
							...
							${process.env.SERVICE_DB_DB2_NAME}.app2_group_place  gp1, 
							${process.env.SERVICE_DB_DB2_NAME}.app2_group_place  gp2,
							${process.env.SERVICE_DB_DB2_NAME}.app2_place        p
