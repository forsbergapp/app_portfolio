...
const template = () => ` <div id='menu_installation_content_widget1' class='widget'>
                                <div id='menu_installation_demo'>
                                    <div id='menu_installation_demo_demo_users_icon' class='common_icon common_icon_title'></div>
                                    <div id='menu_installation_demo_button_row'>
                                        <div id='menu_installation_demo_button_install' class='common_app_dialogues_button common_icon common_icon_button'></div>
                                        <div id='menu_installation_demo_button_uninstall' class='common_app_dialogues_button common_icon common_icon_button'></div>
                                    </div>
