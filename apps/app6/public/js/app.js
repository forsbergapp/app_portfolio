...
const appPaymentRequestStatus = ()=>{
    if ( new Date().getSeconds() % 2){
        ...
        common.commonFFB({path:'/app-module-function/PAYMENT_REQUEST_GET_STATUS', method:'POST', authorization_type:'APP_DATA',   body:{payment_request_id: payment_request_id}})
        .then((/**@type{*}*/result)=>{
