    ...
    const onMounted = async () =>{
        await props.methods.commonComponentRender({
            ...
            data:       {
                        ...
                        master_path:'/app-module/PRODUCT_GET',
                        master_query:'fields=name,image,description,sku,stock',
                        master_body:{type:'FUNCTION',data_app_id:props.data.app_id, resource_id : 6000},
                        master_method:'POST',
                        master_token_type:'APP_ID',
                        master_resource:'PRODUCT_METADATA',
                        detail_path:'/app-module/PRODUCT_GET',
                        detail_query:'fields=attributes',
                        detail_body:{type:'FUNCTION',data_app_id:props.data.app_id, resource_id : 6000},
                        detail_method:'POST',
