 ...
 */
const payment_metadata = async (app_id, data, user_agent, ip, locale) =>{
    ...
    return await get(app_id, data.resource_id, null, data.data_app_id, 'PAYMENT_METADATA', data.entity_id, locale, true);
};
export default payment_metadata;