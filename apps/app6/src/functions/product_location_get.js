 ...
 *                              {key_name:string, key_value:string, key_type:string}]}]>}
 */
const product_location_get = async (app_id, data, ip, locale) =>{
    ...
    const product_variant_location_metadata = await MasterGet(app_id, null, null, data.data_app_id, 'PRODUCT_VARIANT_LOCATION_METADATA', data.entity_id, locale, true);
    /**@ts-ignore */
