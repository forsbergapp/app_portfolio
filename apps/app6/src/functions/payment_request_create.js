 ...
 * @typedef {server_server_response & {result?:{token:string,
 *                                              exp:number,
 *                                              iat:number,
 ...
 *                                              countdown:string}[]}} paymentRequestCreate
 */
...
const paymentRequestCreate = async parameters =>{
	...
	if (parameters.data.currency_code==currency.currency_code && parameters.data.payerid !='' && parameters.data.payerid !=null){
        ...
        */
        ...
        const body_encrypted = {id:     fileModelAppSecret.get({app_id:parameters.app_id, resource_id:parameters.app_id}).result[0].merchant_id,
