    ...
    for (const product of products.result){
        ...
        const product_variants = AppDataResourceDetail.get({app_id:parameters.app_id, 
                                                            ...
                                                            data:{  iam_user_id:null,
                                                                    ...
                                                                    app_data_resource_master_id:product.id,
                                                                    app_data_entity_id:Entity.id
                                                            }});
        for (const product_variant of product_variants.result){
            ...
            product.sku_keys.push({key_name:'currency_code', key_value:currency.result[0].json_data.currency_code, key_type:'TEXT'});
            product.sku_keys.push({key_name:'currency_symbol', key_value:currency.result[0].json_data.currency_symbol, key_type:'TEXT'});
