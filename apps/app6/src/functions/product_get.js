...
const product_get = async (app_id, data, user_agent, ip, locale, res) =>{
    ...
    const products = await dbModelAppDataResourceMaster.get({   app_id:app_id, 
    ...
    for (const product of products.rows ?? products){
        product.sku = [];
        const product_variants = await dbModelAppDataResourceDetail.get({   app_id:app_id, 
                                                                            resource_id:data.resource_id_variant, 
        ...
        for (const product_variant of product_variants.rows ?? product_variants){
            ...
            const product_variant_metadatas = await dbModelAppDataResourceMaster.get({  app_id:app_id, 
                                                                                        resource_id:data.resource_id, 
                                                                                        data:{  data_app_id:data.data_app_id,
