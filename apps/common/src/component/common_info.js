                            ...
                            <body>
                                <div class='common_info_content'>
                                    ${props.type=='INFO_DISCLAIMER'?
                                        `<div class='common_info_text_h1'>Legal disclaimer</div>
                                        ${props.app_name} is provided "as is" without warranty of any kind. `:''
                                    }
                                    ${props.type=='INFO_PRIVACY_POLICY'?
                                        `<div class='common_info_text_h1'>Privacy Policy</div>
                                        <div class='common_info_text_p'>
                                        ...
                                        <div class='common_info_text_h1'>How to delete your account in this App</div>
                                        <div class='common_info_text_p'>1.Log in with your user account in main app.</div>
                                        <div class='common_info_text_p'>2.Choose Edit in user menu.</div>
                                        <div class='common_info_text_p'>3.Choose Delete Account.</div>`:''
                                    }
                                    ${props.type=='INFO_TERMS'?
                                        `<div class='common_info_text_h1'>Terms</div>
                                        ${props.app_name} is provided "as is" without warranty of any kind. `:''
                                    }
                                </div> 
                            </body>`;
