...
A refactored stateless version of JSDoc is also provided in the documentation.
...
Following instructions are for the refactored stateless version of JSDoc provided in the documentation.
...
|@namespace		|@memberof	|used to categorize functions, ex `REST_API` 		|
