...
Finding common factors in MongoDB, MariaDB, Mysql, PostgreSQL, Oracle and SQLite databases to implement easier maintainable REST API 
and data model.
Consolidate ideas from Vue, React, Oracle Forms, Oracle Reports and Oracle APEX, existing log and 
...
- MongoDB, MariaDB, MySQL, PostgreSQL, Oracle and SQLite as reference to implement database patterns
...
- stateless app meaning cookies, local storage, browse caching, window object storage and progressive web app workers should not be used in the browser
