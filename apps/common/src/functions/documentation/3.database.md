...
|one endpoint for everything complex documentaion|separate endpoints using openAPI and IAM using documentation as single truth of source with JSDoc comments|
