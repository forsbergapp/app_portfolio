...
[![Data model of database implemented using pure text JSON files, Object Relation Mapping [ORM] pattern, cached JSON parsed objects for performance and supports PK,  UK , FK including cascade delete, transaction, rollback, commit, race condition and ACID patterns. ](/common/documents/data_model_small.webp)](/common/documents/data_model.webp)
