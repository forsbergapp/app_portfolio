...
|5.2.2      |1    |**Implemented**.  Allows JSON from client only with image inside encrypted JSON and server controls content of the image for all users image updates and only accepts supported image formats. See also 1.3.1 and 1.3.3|
