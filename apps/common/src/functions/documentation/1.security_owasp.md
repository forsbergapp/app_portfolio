...
|3.7.4      |3    |**Not aplicable**. HST and TLS are not used. Project does not allow the use of third party controlled HTTPS. See 1.2.2, 3.2.1 and 3.6.1 and about customizable Web Crypto API pattern implemented.|
...
|9.2.3      |2    |**Implemented**. Aud key is saved in the JWT token with the only audience implemented. Higher security is implemented to authenticate token as explained in 6.8.2 so implicitly not aplicable|
...
|10.4.10     |2    |**Not aplicable**. See 10.1.1.|
|10.4.11     |2    |**Implemented**. See 10.1.1.|
|10.4.12     |3    |**Not aplicable**. See 10.1.1.|
|10.4.13     |3    |**Not aplicable**. See 10.1.1.|
|10.4.14     |3    |**Not aplicable**. See 10.1.1.|
|10.4.15     |3    |**Not aplicable**. See 10.1.1.|
|10.4.16     |3    |**Not aplicable**. See 10.1.1.|
|10.5.1      |2    |**Not aplicable**. See 10.1.1.|
|10.5.2      |2    |**Not aplicable**. See 10.1.1.|
|10.5.3      |2    |**Not aplicable**. See 10.1.1.|
|10.5.4      |2    |**Not aplicable**. See 10.1.1.|
|10.5.5      |2    |**Not aplicable**. See 10.1.1.|
|10.6.1      |2    |**Not aplicable**. See 10.1.1.|
|10.6.2      |2    |**Not aplicable**. See 10.1.1.|
|10.7.1      |2    |**Not aplicable**. See 10.1.1.|
|10.7.2      |2    |**Not aplicable**. See 10.1.1.|
|10.7.3      |2    |**Not aplicable**. See 10.1.1.|

**V11 Cryptography**
|{#2kv}Requirement|Level|Status|
|:----------|:----|:-----|
|11.1.1      |2    |**Implemented**. Uses OpenApi with JSDoc integrated documentation that is displayed in Presentation App with additional security documentation includes about policy for management of cryptographic keys and cryptographic key lifecycle defined in NIST SP 800-57 as secure generation, storage, distribution, use and destruction.|
|11.1.2      |2    |**Implemented**. See 11.1.1|
|11.1.3      |3    |**Implemented**. See 11.1.1|
|11.1.4      |3    |**Implemented**. Documented plan that outlines migration path to new cryptographic standards available in the Presentation App and the security implementation menu item. See 11.1.1. |
...
|{#2kv}Requirement|Level|Status|
|:----------|:----|:-----|
|12.1.1      |1    |**Not aplicable,  refactored OWASP security**. See 3.7.4.|
|12.1.2      |2    |**Not aplicable,  refactored OWASP security**. See 3.7.4.|
|12.1.3      |2    |**Not aplicable,  refactored OWASP security**. See 3.7.4.|
|12.1.4      |3    |**Not aplicable,  refactored OWASP security**. See 3.7.4 and 4.1.2 about why not use OCSP.|
|12.1.5      |3    |**Not aplicable,  refactored OWASP security**. See 3.7.4.|
|12.2.1      |1    |**Not aplicable,  refactored OWASP security**. See 3.7.4 and 4.1.2 about why HTTPS and OCSP are replaced with safe custom Web Crypto API pattern and HTTP.|
|12.2.2      |1    |**Not aplicable,  refactored OWASP security**. See 3.7.4.|
|12.3.1      |2    |**Not aplicable,  refactored OWASP security**. See 3.7.4.|
|12.3.2      |2    |**Not aplicable,  refactored OWASP security**. See 3.7.4.|
|12.3.3      |2    |**Not aplicable,  refactored OWASP security**. See 3.7.4.|
|12.3.4      |2    |**Not aplicable,  refactored OWASP security**. See 3.7.4.|
|12.3.5      |3    |**Not aplicable,  refactored OWASP security**. See 3.7.4. Microservices use different and enhanced security configuration compared to user security accessed from the browser and are by default blocked from public access in the firewall|

**V13 Configuration**
|{#2kv}Requirement|Level|Status|
|:----------|:----|:-----|
|13.1.1      |2    |**Implemented**. Uses OpenApi.|
|13.1.2      |3    |**Not implemented**. Maximum number of concurrent connections not defined however see 2.4.1 about rater limiter and IAM request control|
...
|13.2.1      |2    |**Implemented**.  All communications at the backend are authenticated and explained in Presentation App|
...
|13.2.4      |2    |**Implemented**.  Uses OpenApi to define and to document what is allowed to access and presented in the Presentation App|
|13.2.5      |2    |**Implemented**.  See 13.2.4|
|13.2.6      |3    |**Not aplicable**.  Uses OpenApi to allow client to access to main server only. Accessing microservice is from the server only. There is no maximum parallel connections implemented for microservices and only batch microservice is implemented and not accessed from clients so requirement not aplicable. See also 13.1.3|
...
|13.3.3      |3    |**Implemented**.  All cryptographic server operations are performed in isolated security module and explained in security menu in Presentation App|
...
|14.2.5      |3    |**Not aplicable, refactored OWASP security**. Unsecure browser cache functionality not allowed and replaced with application managing cache using closure pattern. See 3.2.1 and 14.1.1 |
