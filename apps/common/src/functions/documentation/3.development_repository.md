...
|/data/microservice/data/                               |microservice data directory to cache data if necessary|
|/data/terraform                                        |optional Terraform files|
|/dev                                                   |development source of data model, diagram and images|
|/docs                                                  |installation instructions|
|/node_modules                                          |Node.js modules |
|/sdk/crypto.js                                         |SDK crypto for browser and server, shared by app instances, server and microservices|
|/sdk/server/serviceregistry.js                         |SDK Service Registry API for server, used by microservices|
|/server                 |server files|
|/server/db/[ORMObject]  |database files using Object Relational Mapping (ORM), each filename same as object name in database|
