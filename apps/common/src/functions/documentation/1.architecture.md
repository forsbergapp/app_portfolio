...
Uses Linux development and Linux server for production and test and follows Open Source directive.
Server uses Node.js without any npm modules in production.
Both development and server follow OWASP guidelines.
