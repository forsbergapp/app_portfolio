# Installation environments with Terrraform
...
export TF_LOG=DEBUG
terraform -chdir=$HOME/app_portfolio/data/terraform init
...
```
## Terraform commands
syntax to execute from any directory
```
//TEST
...
//if old exists
rm -f $HOME/.ssh/TEST_private.key
...
//if old exists
rm -f $HOME/.ssh/PRODUCTION_private.key
//save private key and with correct file attritbutes
...
replace ${ENVIRONMENT} with real name
