...
|/data/db/app_data.json                                 ||
|/data/db/app_data_entity.json                          ||
|/data/db/app_data_entity_resource.json                 ||
|/data/db/app_data_resource_detail_data.json            ||
|/data/db/app_data_resource_detail.json                 ||
|/data/db/app_data_resource_master.json                 ||
...
|/data/db/app.json                                      ||
|/data/db/sqlite.db                                     ||
|/data/db/backup/app_data.[ISO8601].json                |`:` replaced with `.` in filename|
|/data/db/backup/app_data_entity.json.[ISO8601].json    |`:` replaced with `.` in filename|
|/data/db/backup/app_data_entity_resource.json.[ISO8601].json  |`:` replaced with `.` in filename|
|/data/db/backup/app_data_resource_detail_data.json.[ISO8601].json |`:` replaced with `.` in filename|
|/data/db/backup/app_data_resource_detail.json.[ISO8601].json  |`:` replaced with `.` in filename|
|/data/db/backup/app_data_resource_master.json.[ISO8601].json  |`:` replaced with `.` in filename|
...
|/data/db/backup/app_translation.[ISO8601].json         |`:` replaced with `.` in filename|
|/data/db/backup/app.[ISO8601].json                     |`:` replaced with `.` in filename|
|/data/db/jobs/[Date.now()].html                        |Report queue files|
|/data/iam/iam_app_id_token.json                        ||
|/data/iam/iam_control_ip.json                          |optional file|
|/data/iam/iam_control_observe.json                     ||
|/data/iam/iam_control_user_agent.json                  |optional file|
|/data/iam/iam_app_access.json                          ||
|/data/iam/iam_user.json                                ||
|/data/iam/backup/iam_app_id_token.[ISO8601].json       |`:` replaced with `.` in filename|
...
|/data/iam/backup/iam_user_app_access.[ISO8601].json    |`:` replaced with `.` in filename|
...
|/server                 |server files|
|/server/db              |database files using Object Relational Mapping (ORM)|
