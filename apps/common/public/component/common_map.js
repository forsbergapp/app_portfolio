...
const component = async props => {
    ...
    const getPlace = async parameters =>
        await props.methods.COMMON.commonFFB({
            ...
            query:`locale=${props.methods.COMMON.commonGlobalGet('Data').UserApp.user_locale}&longitude=${parameters.longitude}&latitude=${parameters.latitude}`, 
            method:'GET', 
    ...
    const goTo = async parameters =>{
        ...
        const place =  parameters.ip?
                            await props.methods.COMMON.commonFFB({ 
                                                            path:'/geolocation/ip', 
                                                            query:`locale=${props.methods.COMMON.commonGlobalGet('Data').UserApp.user_locale}&ip=${parameters.ip}`, 
                                                            method:'GET', 
