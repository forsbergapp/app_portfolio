 ...
 * @returns {string}
 */
const template = props => ` <div id='common_dialogue_iam_edit_iamuser'>
                                <div class='common_dialogue_iam_edit_iamuser_row_title'>
                                    <div id='common_dialogue_iam_edit_avatar' data-image=${props.user.avatar} class='common_image common_image_avatar' style='${props.user.avatar==null?'':`background-image:url(${props.user.avatar});`}'>
                                ...
                                <div class='common_dialogue_iam_edit_iamuser_row'>
                                ...
                                <div class='common_dialogue_iam_edit_iamuser_row'>
                                    <div id='common_dialogue_iam_edit_input_otp_icon' class='common_icon'></div>
                                    <div id='common_dialogue_iam_edit_input_otp_key'>******</div>
                                </div>
                                <div class='common_dialogue_iam_edit_iamuser_row'>
