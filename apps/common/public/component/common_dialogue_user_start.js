/**
 * @module apps/common/component/common_dialogue_user_start
 */
...
const template = props =>`  <div id='common_user_start_logo' class='common_image common_image_logo_start'></div>
                            ${props.admin_app?'':
                               `<div id='common_user_start_nav'>
                                    <div id='common_user_start_login'  class='common_icon ${props.type=='LOGIN'?'common_user_start_selected':''}'></div>
                                    <div id='common_user_start_signup' class='common_icon ${props.type=='SIGNUP'?'common_user_start_selected':''}'></div>
                                    <div id='common_user_start_forgot' class='common_icon ${props.type=='FORGOT'?'common_user_start_selected':''}'></div>
                                </div>`
                            }
                            ${props.admin_app?
                                `<div id='common_user_start_login_admin_form' class='common_user_start_form'>
                                    ${props.first_time?
                                        `<div id='common_user_start_login_admin_first_time'>
                                        </div>`:''
                                    }
                                    <div id='common_user_start_login_admin_username' contentEditable='true' class='common_input common_placeholder' ></div>
                                    <div class='common_password_container'>
                                        <div id='common_user_start_login_admin_password' contentEditable='true' class='common_input common_password common_placeholder' ></div>
                                        <div id='common_user_start_login_admin_password_mask' class='common_input common_password_mask'></div>
                                    </div>
                                    ${props.first_time?
                                        `<div id='common_user_start_login_admin_password_confirm_container'>
                                            <div class='common_password_container'>
                                                <div id='common_user_start_login_admin_password_confirm' contentEditable="true" class='common_input common_password common_placeholder' ></div>
                                                <div id='common_user_start_login_admin_password_confirm_mask' class='common_input common_password_mask'></div>
                                            </div>
                                        </div>`:''
                                    }
                                    <div id='common_user_start_login_admin_button' class='common_dialogue_button common_user_start_button common_icon' ></div>
                                </div>`:
                                `${props.type=='LOGIN'? 
