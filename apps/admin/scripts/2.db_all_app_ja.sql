...
-- app_translation app
--
INSERT INTO <DB_SCHEMA/>.app_translation (app_id, language_id, json_data) VALUES (0,224,'{"name":"管理者", "description":"アプリ管理者とシステム管理者向けの管理アプリで、構成、ライブ接続とログの監視、統計、ブロードキャスト機能、データベース情報、OS 情報、プロセス情報、およびユーザー ロール管理"}');
--
