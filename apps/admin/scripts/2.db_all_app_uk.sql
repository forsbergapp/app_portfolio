...
-- app_translation app
--
INSERT INTO app_portfolio.app_translation (app_id, language_id, json_data) VALUES (0,564,'{"name":"Aдмін", "description": "Адміністраторська програма для адміністраторів програм і системних адміністраторів із конфігурацією, моніторингом живих з’єднань і журналів, статистикою, функції трансляції, інформація про базу даних, інформація про ОС, інформація про процеси та керування ролями користувачів"}');
--
