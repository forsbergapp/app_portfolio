...
-- app_translation app
--
INSERT INTO app_portfolio.app_translation (app_id, language_id, json_data) VALUES (0,531,'{"name":"అడ్మిన్", "description": "కాన్ఫిగరేషన్‌తో యాప్ అడ్మిన్‌లు మరియు సిస్టమ్ అడ్మిన్‌ల కోసం అడ్మిన్ యాప్, లైవ్ కనెక్షన్‌లు మరియు లాగ్‌ల పర్యవేక్షణ, గణాంకాలు, ప్రసార విధులు, డేటాబేస్ సమాచారం, OS సమాచారం, ప్రక్రియ సమాచారం మరియు వినియోగదారు పాత్ర నిర్వహణ"}');
--
