...
-- app_translation app
--
INSERT INTO app_portfolio.app_translation (app_id, language_id, json_data) VALUES (0,147,'{"name":"Admin", "description":"Admin app for app admins and system admins with configuration, monitoring of live connections and logs, statistics, broadcast functions, database info, OS info, process info and user role management"}');
--
