...
-- app_translation app
--
INSERT INTO app_portfolio.app_translation (app_id, language_id, json_data) VALUES (0,453,'{"name":"Aдмин", "description": "Приложение администратора для администраторов приложений и системных администраторов с конфигурацией, мониторингом активных подключений и журналов, статистикой, широковещательные функции, информация о базе данных, информация об ОС, информация о процессах и управление ролями пользователей"}');
--
