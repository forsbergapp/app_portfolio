 ...
 * @returns 
 */
const template = props => ` <div id='bank_statement_account'>
                                <div id='bank_statement_bank_statement_row'>
                                    <div class='bank_statement_bank_statement_col'>
                                        <div id='bank_statement_account'>${props.bank_account}</div>
                                        <div id='bank_statement_statement_date'>${props.bank_statement_date}</div>
                                        <div id='bank_statement_balance'>${props.transactions.length>0? 
                                                                                props.bank_currency_symbol + 
                                                                                props.function_format_number(props.function_account_balance(props.transactions)):''}</div>
                                        <div id='bank_statement_currency'>${props.bank_currency_text}</div>
                                    </div>
                                    <div class='bank_statement_bank_statement_col'>
                                        <div id='bank_statement_bank_name'>${props.bank_name}</div>
                                    </div>
                                </div>
                                <div id='bank_statement_transactions'>
                                    <div id='bank_statement_transactions_search' class='common_search'>
                                        <div id='bank_statement_transactions_search_input' contenteditable='true' class='common_input common_search_input'></div>
                                        <div id='bank_statement_transactions_search_icon' class='common_icon common_search_icon'> </div>
                                    </div>
                                    <div id='bank_statement_transactions_title_row'>
                                        <div id='bank_statement_transactions_title_date'></div>
                                        <div id='bank_statement_transactions_title_time'></div>
                                        <div id='bank_statement_transactions_title_logo'></div>
                                        <div id='bank_statement_transactions_title_origin'></div>
                                        <div id='bank_statement_transactions_title_amount_deposit'></div>
                                        <div id='bank_statement_transactions_title_amount_withdrawal'></div>
                                    </div>
                                    <div id='bank_statement_transactions_list' <SPINNER_CLASS/>>
                                        ${props.transactions.map(row=>
                                            `<div class='bank_statement_transactions_row'>
                                                <div class='bank_statement_transactions_date'>${row.date}</div>
                                                <div class='bank_statement_transactions_time'>${row.time}</div>
                                                <div class='bank_statement_transactions_logo'>${row.logo}</div>
                                                <div class='bank_statement_transactions_origin'>${row.origin}</div>
                                                <div class='bank_statement_transactions_amount_deposit'>${props.function_format_number(row.amount_deposit)}</div>
                                                <div class='bank_statement_transactions_amount_withdrawal'>${props.function_format_number(row.amount_withdrawal)}</div>
                                            </div>`
                                            ).join('')
                                        }
                                    </div>
...
const component = async props => {
    ...
    const post_component = async () =>{
        ...
        //const transactions = await props.function_FFB(path, query, 'GET', 'APP_DATA', null)
