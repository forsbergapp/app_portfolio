 ...
 */
const customer_get = async (app_id, data, locale) =>{
    ...
    return await get(app_id, data.resource_id, data.user_account_id, data.data_app_id, 'CUSTOMER', data.entity_id, data.locale, false);
};
