...
const appInit = async parameters => {
    const appLibTimetable_path = `/bff/app/v${common.COMMON_GLOBAL.app_rest_api_version}/app-module-module/MODULE_LIB_TIMETABLE?parameters=${common.commonWindowToBase64(`type=MODULE&data_app_id=${common.COMMON_GLOBAL.app_id}`)}`;
    /**@type {CommonModuleLibTimetable} */
